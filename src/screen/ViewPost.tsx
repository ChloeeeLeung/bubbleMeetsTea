      ...
      <ScrollView>
        ...
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.content}>
            Introducing a new tea shop in Causeway Bay!
            Indulge in premium teas, from green to black, herbal to iced. Discover a serene
        ...
        <View style={styles.shopInfoContainer}>
          ...
          <Text style={styles.shopLocation}>
            Shop No. B240, Basement 2, Times Square, 1 Matheson Street, Causeway Bay, Hong Kong.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
